 ...
 */
namespace addons\rlsms\library;
/**
 * 短信的发送
 */
class Rest
{
    ...
    function __construct($ServerIP = 'https://sandboxapp.cloopen.com', $ServerPort = '8883', $SoftVersion = '2013-12-26')
    {
        ...
        $this->Filename = LOG_PATH . 'rlsms.txt';
    }
     ...
     */
    function setAccount($AccountSid = 'aaf98f8951adaa740151af114d450591', $AccountToken = 'a5db8516bba44b049dacbe479b79faf7')
    {
     ...
     * @param AppId 应用ID
     */
    function setAppId($AppId = '8a48b55151adad9b0151af11ade3058d')
    {
        $this->AppId = $AppId;
    }
