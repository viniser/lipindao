<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/www/wwwroot/fenzhandemo/public/../application/admin/view/user/user/edit.html";i:1540283580;s:67:"/www/wwwroot/fenzhandemo/application/admin/view/layout/default.html";i:1536722460;s:64:"/www/wwwroot/fenzhandemo/application/admin/view/common/meta.html";i:1536722460;s:66:"/www/wwwroot/fenzhandemo/application/admin/view/common/script.html";i:1536722460;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-price" class="control-label col-xs-12 col-sm-2">单价:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-price" data-rule="" class="form-control" name="row[price]" type="text" value="<?php echo $row['price']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-score" data-rule="required" class="form-control" name="row[score]" type="number" value="<?php echo $row['score']; ?>" disabled>
        </div>
    </div>
    <div class="form-group">
